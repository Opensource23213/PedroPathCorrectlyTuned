...
public class BlueWithBucket extends OpMode {
    ...
    public void init() {
        ...
        push3ish = new Path(new BezierCurve(new Point(50.6, -46.8, Point.CARTESIAN), new Point(39.2, -46.8, Point.CARTESIAN), new Point(16.7, -46.8, Point.CARTESIAN), new Point(4, -46.8, Point.CARTESIAN)));push3.setConstantHeadingInterpolation(0);
        ...
        comeback1ish = new Path(new BezierLine(new Point(10, -16.8, Point.CARTESIAN), new Point(2, -16.9, Point.CARTESIAN)));
