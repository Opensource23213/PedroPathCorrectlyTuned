...
public class Score5Auto extends OpMode {
    ...
    public void init() {
        ...
        push3 = new Path(new BezierCurve(new Point(13.8, -40, Point.CARTESIAN), new Point(27.3, -39.9, Point.CARTESIAN), new Point(39, -40.7, Point.CARTESIAN), new Point(42, -41.3, Point.CARTESIAN),new Point(44.6, -45.8, Point.CARTESIAN)));
        push3ish = new Path(new BezierCurve(new Point(50.6, -45.8, Point.CARTESIAN), new Point(39.2, -44.8, Point.CARTESIAN), new Point(16.7, -44.8, Point.CARTESIAN), new Point(4, -44.8, Point.CARTESIAN)));
